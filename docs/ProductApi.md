...
# **getProducts**
> InlineResponse2003 getProducts(byBrand, byCategory, isRental, sort, page)
...
try {
    InlineResponse2003 result = apiInstance.getProducts(byBrand, byCategory, isRental, sort, page);
    System.out.println(result);
} catch (ApiException e) {
...
# **searchProduct**
> InlineResponse2003 searchProduct(q, page)
...
Integer page = 56; // Integer | pagenumber
try {
    InlineResponse2003 result = apiInstance.searchProduct(q, page);
    System.out.println(result);
} catch (ApiException e) {
