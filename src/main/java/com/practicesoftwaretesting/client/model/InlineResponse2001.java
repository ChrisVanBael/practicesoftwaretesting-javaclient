...
@javax.annotation.Generated(value = "com.tesuqa.codegen.v3.generators.java.JavaClientCodegen", date = "2024-05-22T17:28:46.407007930Z[GMT]")
...
public class InlineResponse2001 {
  ...
  **/
  ...
  public InlineResponse2001 data(List<ProductResponse> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2001 addDataItem(ProductResponse dataItem) {
    if (this.data == null) {
