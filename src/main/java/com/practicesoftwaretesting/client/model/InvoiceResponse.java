...
public class InvoiceResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, invoiceDate, invoiceNumber, billingAddress, billingCity, billingCountry, billingState, billingPostcode, total, paymentMethod, paymentAccountName, paymentAccountNumber, status, statusMessage, invoiceItems);
  }
