...
public class ProductApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2005 getProducts(Integer byBrand, Integer byCategory, String isRental) throws ApiException {
        ApiResponse<InlineResponse2005> resp = getProductsWithHttpInfo(byBrand, byCategory, isRental);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2005> getProductsWithHttpInfo(Integer byBrand, Integer byCategory, String isRental) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProductsAsync(Integer byBrand, Integer byCategory, String isRental, final ApiCallback<InlineResponse2005> callback) throws ApiException {
