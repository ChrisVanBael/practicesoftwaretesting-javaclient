...
public class ProductApi {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProductAsync(Integer productId, final ApiCallback<ProductResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getProductsCall(Integer byBrand, Integer byCategory, String isRental, String sort, Integer page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getProductsValidateBeforeCall(Integer byBrand, Integer byCategory, String isRental, String sort, Integer page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getProductsCall(byBrand, byCategory, isRental, sort, page, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2003 getProducts(Integer byBrand, Integer byCategory, String isRental, String sort, Integer page) throws ApiException {
        ApiResponse<InlineResponse2003> resp = getProductsWithHttpInfo(byBrand, byCategory, isRental, sort, page);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2003> getProductsWithHttpInfo(Integer byBrand, Integer byCategory, String isRental, String sort, Integer page) throws ApiException {
        com.squareup.okhttp.Call call = getProductsValidateBeforeCall(byBrand, byCategory, isRental, sort, page, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProductsAsync(Integer byBrand, Integer byCategory, String isRental, String sort, Integer page, final ApiCallback<InlineResponse2003> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getProductsValidateBeforeCall(byBrand, byCategory, isRental, sort, page, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2003>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2003 searchProduct(String q, Integer page) throws ApiException {
        ApiResponse<InlineResponse2003> resp = searchProductWithHttpInfo(q, page);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2003> searchProductWithHttpInfo(String q, Integer page) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchProductAsync(String q, Integer page, final ApiCallback<InlineResponse2003> callback) throws ApiException {
