...
public class ProductApi {
    ...
    public List<ProductResponse> getProducts(Integer byBrand, Integer byCategory, String isRental) throws ApiException {
        ApiResponse<List<ProductResponse>> resp = getProductsWithHttpInfo(byBrand, byCategory, isRental);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProductsAsync(Integer byBrand, Integer byCategory, String isRental, final ApiCallback<List<ProductResponse>> callback) throws ApiException {
