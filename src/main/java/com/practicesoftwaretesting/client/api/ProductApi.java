...
public class ProductApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getProductsCall(Integer byBrand, Integer byCategory, String sort, Integer page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getProductsValidateBeforeCall(Integer byBrand, Integer byCategory, String sort, Integer page, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getProductsCall(byBrand, byCategory, sort, page, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2001 getProducts(Integer byBrand, Integer byCategory, String sort, Integer page) throws ApiException {
        ApiResponse<InlineResponse2001> resp = getProductsWithHttpInfo(byBrand, byCategory, sort, page);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> getProductsWithHttpInfo(Integer byBrand, Integer byCategory, String sort, Integer page) throws ApiException {
        com.squareup.okhttp.Call call = getProductsValidateBeforeCall(byBrand, byCategory, sort, page, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getProductsAsync(Integer byBrand, Integer byCategory, String sort, Integer page, final ApiCallback<InlineResponse2001> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getProductsValidateBeforeCall(byBrand, byCategory, sort, page, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<InlineResponse2001>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2001 searchProduct(String q, Integer page) throws ApiException {
        ApiResponse<InlineResponse2001> resp = searchProductWithHttpInfo(q, page);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse2001> searchProductWithHttpInfo(String q, Integer page) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchProductAsync(String q, Integer page, final ApiCallback<InlineResponse2001> callback) throws ApiException {
