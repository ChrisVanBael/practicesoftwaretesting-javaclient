...
public class InvoiceApiTest {
    ...
    public void downloadPDFTest() throws Exception {
        ...
        InvoiceResponse response = api.downloadPDF(invoiceNumber);
     ...
     */
    @Test
    public void downloadPDFStatusTest() throws Exception {
        String invoiceNumber = null;
        InvoiceResponse response = api.downloadPDFStatus(invoiceNumber);
    ...
    public void getInvoicesTest() throws Exception {
        Integer page = null;
        InlineResponse2003 response = api.getInvoices(page);
    ...
    public void searchInvoiceTest() throws Exception {
        String q = null;
        Integer page = null;
        InlineResponse2003 response = api.searchInvoice(q, page);
