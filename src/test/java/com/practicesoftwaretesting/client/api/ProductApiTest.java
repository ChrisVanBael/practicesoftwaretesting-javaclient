...
public class ProductApiTest {
    ...
    public void getProductsTest() throws Exception {
        ...
        String sort = null;
        Integer page = null;
        InlineResponse2005 response = api.getProducts(byBrand, byCategory, isRental, between, sort, page);
    ...
    public void searchProductTest() throws Exception {
        String q = null;
        Integer page = null;
        InlineResponse2005 response = api.searchProduct(q, page);
    ...
    public void storeProductTest() throws Exception {
        ...
        InlineResponse2011 response = api.storeProduct(body);
