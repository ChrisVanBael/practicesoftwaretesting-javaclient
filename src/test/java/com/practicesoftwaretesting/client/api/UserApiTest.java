...
public class UserApiTest {
    ...
    public void getUsersTest() throws Exception {
        Integer page = null;
        List<UserResponse> response = api.getUsers(page);
    ...
    public void logOutTest() throws Exception {
        InlineResponse2006 response = api.logOut();
    ...
    public void loginCustomerTest() throws Exception {
        ...
        InlineResponse2005 response = api.loginCustomer(body);
    ...
    public void refreshTokenTest() throws Exception {
        InlineResponse2005 response = api.refreshToken();
    ...
    public void searchUserTest() throws Exception {
        String q = null;
        Integer page = null;
        List<UserResponse> response = api.searchUser(q, page);
