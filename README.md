...
Toolshop API
- API version: 0.4.0
  - Build date: 2023-01-29T12:30:11.276Z[GMT]

Toolshop REST API technical description


Automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen)*  
from https://api-v4.practicesoftwaretesting.com/api/documentation
...
```groovy
compile "com.practicesoftwaretesting:client:0.4.0"
```
