...
Toolshop API
- API version: 0.1.0
  - Build date: 2023-01-29T11:12:54.585Z[GMT]

Toolshop REST API technical description


Automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen)*  
from https://api-v1.practicesoftwaretesting.com/api/documentation
...
```groovy
compile "com.practicesoftwaretesting:client:0.1.0"
```
...
* `target/practicesoftwaretesting-javaclient-0.1.0.jar`
* `target/lib/*.jar`
